...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#153d63', fontWeight: '800', fontSize: 18 },
  ...
  list: { gap: 8 },
  flatCard: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#d8e3f0', borderRadius: 10, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  flatTextWrap: { flex: 1, paddingRight: 8 },
  flatTitle: { color: '#153d63', fontWeight: '800' },
  ...
  editor: { backgroundColor: '#f7fafe', borderWidth: 1, borderColor: '#d8e3f0', borderRadius: 10, padding: 10, marginTop: 8 },
  editorTitle: { color: '#153d63', fontWeight: '800', fontSize: 16 },
